...
//variables
const int start_user = 0; //position user are starting their journey (0-15)
...
const int end_zone2 = 6; //position zone 2 ends (1-15, and has to be bigger or equal to start of zone 2, bigger than end of zone 1 and smaller than start of zone 3)
const int start_zone3 = 7; //position zone 3 starts (1-15, and has to be bigger than end of zone 2)
...
const double gsm_fail = 0.2; //probability gsm can't locate phone
const double wifi_fail = 0.2; //probability wifi can't locate phone
const double gps_fail = 0.165; //probability gps can't locate phone
const double no_checkin = 0.005; //probability of user forgetting to check-in 
...
[] (z2=1 | z2=2) & p=(start_zone2 + 1) & ((start_zone2+1) < end_zone2) -> (z2'=2); //user is located in zone
[] p=end_zone2 -> (z2'=4); //check if user reached end of the zone, if yes move to end of module z=4
[] (z2=1 | z2=2) & p=(start_zone2 + 2) & ((start_zone2+2) < end_zone2) -> (z2'=2); //user is located in zone
[] p=end_zone2 -> (z2'=4); //check if user reached end of the zone, if yes move to end of module z=4
[] (z2=1 | z2=2) & p=(start_zone2 + 3) & ((start_zone2+3) < end_zone2) -> (z2'=2); //user is located in zone
[] p=end_zone2 -> (z2'=4); // heck if user reached end of the zone, if yes move to end of module z=4
[] (z2=1 | z2=2) & p=(start_zone2 + 4) & ((start_zone2+4) < end_zone2) -> (z2'=2); //user is located in zone
[] p=end_zone2 -> (z2'=4); //check if user reached end of the zone, if yes move to end of module z=4
...
[] p=end_zone3 -> (z3'=4);
[] (z3=1 | z3=2) & p=(start_zone3 + 1) & ((start_zone3+1) < end_zone3) -> (z3'=2); //user is located in zone
[] p=end_zone3 -> (z3'=4);
[] (z3=1 | z3=2) & p=(start_zone3 + 2) & ((start_zone3+2) < end_zone3) -> (z3'=2); //user is located in zone
[] p=end_zone3 -> (z3'=4);
[] (z3=1 | z3=2) & p=(start_zone3 + 3) & ((start_zone3+3) < end_zone3) -> (z3'=2); //user is located in zone
[] p=end_zone3 -> (z3'=4);
[] (z3=1 | z3=2) & p=(start_zone3 + 4) & ((start_zone3+4) < end_zone3) -> (z3'=2); //user is located in zone
[] p=end_zone3 -> (z3'=4);
